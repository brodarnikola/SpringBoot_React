package com.example.polls.ai_example.services;

import com.example.polls.ai_example.data.*;
...
public class FlightBookingService {
    ...
    private void initDemoData() {
        ...
        var customers = new ArrayList<CustomerFlight>();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            CustomerFlight customer = new CustomerFlight();
